...
/**
 * Service to manage the builtin comments
 */
final class CommentsService {
    /**
     * Enable or not the comments
     *
     * @param boolean $enabled Enable or not the comments
     */
     ...
     */
    protected static function disable_comments() : void {
